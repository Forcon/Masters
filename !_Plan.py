...
Сделать возможность на один е-мейл авторизовать несколько пользователей с разными магазинами на ЯМ (- 3й -)
Сделать свое выпадающее предупреждение вместо стандартного питоновского
Сделать приветствие + какие-то заставки с сообщениями (например: "Вы успешно авторизовались")
