...
Научиться генерить запросы к базе из контрольной панели (собирать "запрос на извлечение из кусочков") (+ понял как!)
Сделать возможность на один е-мейл авторизовать несколько пользователей с разными магазинами на ЯМ
